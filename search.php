...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        <title> <?php echo $_REQUEST["q"]; ?> - NeuMeta-Search</title>
        <meta http-equiv="Content-type" content="application/xhtml+xml;charset=utf-8"/>
        <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
        <meta name="description" content="A meta-search engine optimized for crypto."/>
        <link rel="stylesheet" type="text/css" href="static/styles.css"/>
        <link title="NeuSearch search" type="application/opensearchdescription+xml" href="/opensearch.xml?method=POST" rel="search"/>
        <link rel="shortcut icon" href="/static/neu.png" />
    </head>
    <body>
        <form class="small-search-container" method="post" enctype="multipart/form-data" autocomplete="off">
            <a href="/"><img id="logo" src="static/Neu.png" alt="NeuSearch"></a>
        ...
        <div class="info-container">
            <center>Developed with ❤️ at Neutronium Foundation</center>
        </div>
    </body>
</html>